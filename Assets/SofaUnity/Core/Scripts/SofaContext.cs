...
namespace SofaUnity
{
    ...
    public class SofaContext : MonoBehaviour
    {
        ...
        {
            // Catch up on missed steps instead of stepping at most once per
            // rendered frame - otherwise a lower render framerate silently
            // slows down the physics rate relative to wall-clock time, which
            // makes wall-clock-paced input (catheter insertion via key hold)
